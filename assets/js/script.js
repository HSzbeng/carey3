...
// Dirubah 
const pengirim = "Harry";
const nomorWa = "6282215336864" // awalan nomor 0 harus di awalin 62
const textWa = "Ah bisa aja kamu"
const pesan = `Gak sadar yah? Pada akhirnya kita berdua menjadi dua orang penjahat yah? Kamu yang dengan hebatnya bisa mencuri hatiku, begitu juga aku yang berhasil mencuri hatimu 😍😘`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Kira-kira kamu kangen gak ya?',
    html: `<input type="text" id="login" class="swal2-input" placeholder="Jawab">`,
    confirmButtonText: 'Kirim',
    focusConfirm: false,
    preConfirm: () => {
      const login = Swal.getPopup().querySelector('#login').value
      if (!login) {
        Swal.showValidationMessage(`Jawab :(`)
      }
      return { login }
    }
  })
